<script type="text/javascript" id="bloomerangForm114688"></script>
<pre><script type="text/javascript">
    var insertForm114688 = function() {
        var html114688 = '<style text=\'text/css\'>' + 
...
'      <h3>Donation</h3>' + 
'      <div class="field radio 116736 required" >' + 
'<label for="116736"><input id="116736" name="donation-level" class="required" type="radio" value="25.000000" maxlength="255"></input><span class="label">$25.00 - $25</span></label>' + 
'</div>' + 
'<div class="field radio 116737 required" >' + 
'<label for="116737"><input id="116737" name="donation-level" class="required" type="radio" value="50.000000" maxlength="255"></input><span class="label">$50.00 - $50</span></label>' + 
'</div>' + 
'<div class="field radio 116738 required" >' + 
'<label for="116738"><input id="116738" name="donation-level" class="required" type="radio" value="100.000000" maxlength="255"></input><span class="label">$100.00 - $100</span></label>' + 
'</div>' + 
'<div class="field radio 2540544 required" >' + 
'<label for="2540544"><input id="2540544" name="donation-level" class="required" type="radio" value="500.000000" maxlength="255"></input><span class="label">$500.00 - $500</span></label>' + 
'</div>' + 
'<div class="field radio 2540545 required" >' + 
'<label for="2540545"><input id="2540545" name="donation-level" class="required" type="radio" value="1000.000000" maxlength="255"></input><span class="label">$1,000.00 - $1000</span></label>' + 
'</div>' + 
...
'<label for="consent-all"><input id="consent-all" name="consent-all" type="checkbox" maxlength="255"></input><span class="label">I would like to receive or continue receiving updates from Stepping Stone Communities</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha114688"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml114688 = '<div class=\'donation-success\'>' +
                                                       '  <h2>Thank You for Your Donation!</h2>' +
                                                       '  <p>Your generous gift has been processed. We truly appreciate your continued support. \r\u003cbr /\u003e\r\u003cbr /\u003eFor your records, our tax ID# is 81-1530004</p>' + 
                                                        '   ' + 
                                                        '</div>';( function($) {if (!Bloomerang.useDonationId('114688')) { 
                                    html114688 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                                }if (jQuery('#bloomerangForm114688').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html114688 = '<p style="color: red">​Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade ​your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm114688').after(html114688);
                                            ...
                                            Bloomerang.Util.load('https://core.spreedly.com/iframe/express-2.min.js', 
                                                ...
                                                function() {
                                                    ...
                                                    Bloomerang.initSpreedly = function() {
                                                        SpreedlyExpress.init('OqOMv1ksjPtXEYHtCYsVXzEpCbR', { 'company_name': 'Stepping Stone Communities' });
                                                    };
                    ...
                    Bloomerang.useKey('pub_ccc650bb-1f8d-11e7-bb7f-024e165d44b3');
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml114688);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidation(function() { insertForm114688(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidation(function() { insertForm114688(); })});
                    }
